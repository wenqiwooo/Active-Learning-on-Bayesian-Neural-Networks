...
def neural_network(X):
  ...
  h = tf.tanh(tf.matmul(h, W_4) + b_4)
  h = tf.tanh(tf.matmul(h, W_5) + b_5)
  h = tf.matmul(h, W_6) + b_6
...
with tf.name_scope("model"):
  ...
  W_2 = Normal(loc=tf.zeros([10, 10]), scale=tf.ones([10, 10]), name="W_2")
  W_3 = Normal(loc=tf.zeros([10, 10]), scale=tf.ones([10, 10]), name="W_3")
  W_4 = Normal(loc=tf.zeros([10, 10]), scale=tf.ones([10, 10]), name="W_4")
  W_5 = Normal(loc=tf.zeros([10, 10]), scale=tf.ones([10, 10]), name="W_5")
  W_6 = Normal(loc=tf.zeros([10, 1]), scale=tf.ones([10, 1]), name="W_6")
  ...
  b_3 = Normal(loc=tf.zeros(10), scale=tf.ones(10), name="b_3")
  b_4 = Normal(loc=tf.zeros(10), scale=tf.ones(10), name="b_4")
  b_5 = Normal(loc=tf.zeros(10), scale=tf.ones(10), name="b_5")
  b_6 = Normal(loc=tf.zeros(1), scale=tf.ones(1), name="b_6")
...
with tf.name_scope("posterior"):
  ...
  with tf.name_scope("qW_3"):
    qW_3 = Normal(loc=tf.Variable(tf.random_normal([10, 10]), name="loc"),
                  scale=tf.nn.softplus(
                      tf.Variable(tf.random_normal([10, 10]), name="scale")))
  with tf.name_scope("qW_4"):
    qW_4 = Normal(loc=tf.Variable(tf.random_normal([10, 10]), name="loc"),
                  scale=tf.nn.softplus(
                      tf.Variable(tf.random_normal([10, 10]), name="scale")))
  with tf.name_scope("qW_5"):
    qW_5 = Normal(loc=tf.Variable(tf.random_normal([10, 10]), name="loc"),
                  scale=tf.nn.softplus(
                      tf.Variable(tf.random_normal([10, 10]), name="scale")))
  with tf.name_scope("qW_6"):
    qW_6 = Normal(loc=tf.Variable(tf.random_normal([10, 1]), name="loc"),
                  scale=tf.nn.softplus(
  ...
  with tf.name_scope("qb_3"):
    qb_3 = Normal(loc=tf.Variable(tf.random_normal([10]), name="loc"),
                  scale=tf.nn.softplus(
                      tf.Variable(tf.random_normal([10]), name="scale")))
  with tf.name_scope("qb_4"):
    qb_4 = Normal(loc=tf.Variable(tf.random_normal([10]), name="loc"),
                  scale=tf.nn.softplus(
                      tf.Variable(tf.random_normal([10]), name="scale")))
  with tf.name_scope("qb_5"):
    qb_5 = Normal(loc=tf.Variable(tf.random_normal([10]), name="loc"),
                  scale=tf.nn.softplus(
                      tf.Variable(tf.random_normal([10]), name="scale")))
  with tf.name_scope("qb_6"):
    qb_6 = Normal(loc=tf.Variable(tf.random_normal([1]), name="loc"),
                  scale=tf.nn.softplus(
